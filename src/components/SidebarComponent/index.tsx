...
const sidebarData: SidebarItem[] = [
  ...
  // Pembeli
  { id: 20, name: "Bookmark", link: "/dashboard/bookmark", role: "Pembeli", iconify: "material-symbols:bookmark", moduleKey: "bookmark" },
  { id: 21, name: "Tiket Saya", icon: faTicket, link: "/dashboard/my-ticket", role: "Pembeli", moduleKey: "ticket" },
  ...
  { id: 70, name: "Pesan", icon: faMessage, link: "/dashboard/chat", role: "Pembeli", moduleKey: "chat" },
  { id: 71, name: "Pesan", icon: faMessage, link: "/dashboard/chat-creator", role: "Creator", moduleKey: "chat" },
  { id: 80, name: "Account Saya", icon: faIdBadge, role: "Creator", submenu: profileData, moduleKey: "profile" },
  { id: 81, name: "Account Saya", icon: faIdBadge, role: "Pembeli", submenu: profileData, moduleKey: "profile" },
];
