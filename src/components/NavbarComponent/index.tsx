...
export default function NavbarComponent({ children }: { children: ReactNode }) {
  ...
  return (
    <div>
      ...
      {!route.startsWith('/event') && !route.startsWith('/transaction-woauth') && !route.startsWith('/create-event') && !route.startsWith('/merch-order') && !route.startsWith('/merch-cart') && !route.startsWith('/venue/') && <Footer />}
    </div>
  );
}
