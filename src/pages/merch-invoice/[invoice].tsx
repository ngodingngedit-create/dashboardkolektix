...
import { Box, Card, Container, Divider, Flex, Image, NumberFormatter, SimpleGrid, Stack, Table, Text, Title } from '@mantine/core';
                        ...
                        <Stack gap={30}>
                            <Flex justify="space-between" align="center" wrap="wrap">
                                <Flex gap={15} align="center">
                                    ...
                                    <Stack gap={0}>
                                        <Title order={1} size="h2" className={`uppercase`}>Invoice Pesanan</Title>
                    ...
                    <Stack px={30} py={25} gap={30}>
                        ...
                        <Flex gap={15} className={`[&>*]:flex-grow`} wrap="wrap">
                            ...
                            <Stack gap={10} className={`md:max-w-[300px]`}>
                                ...
                                <Card bg="gray.1">
                                    <SimpleGrid className={`!grid-cols-1 !gap-[10px]`}>
                                        ...
                                        <Link href="#">
                                            <Text size="xs" className={`hover:underline !text-primary-base`}>Buka Link Pembayaran</Text>
                                        </Link>
                                    </SimpleGrid>
                                </Card>
                            </Stack>
