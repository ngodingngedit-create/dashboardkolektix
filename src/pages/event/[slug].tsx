    ...
    detail && (
      ...
      <div className='text-dark w-full'>
        ...
        <Head>
          ...
          <meta
            name='description'
            content={detail ? detail?.description.replace(/(<([^>]+)>)/gi, '') : ''}
          />
          {/* <meta
          name='keywords'
          ...
          (width && width > 768 ? (
            <>
                    ...
                    <div className='w-4/5 pr-5'>
                      ...
                      <div className='flex justify-between items-center text-white px-5 py-4'>
                        ...
                        <div className="relative">
                          ...
                          {isLogin && (
                            <FontAwesomeIcon icon={faBookmarkOutlined} className='text-xl ' />
                          )}
                        </div>
                      </div>
                    </div>
              ...
              <div className='bg-primary-dark sticky top-16'>
                <div className='text-white flex items-center justify-between py-5 px-8 max-w-7xl mx-auto'>
                  <div className='flex gap-5 w-4/5 max-w-5xl mx-auto'>
                    <button
                      onClick={() => setMenu(1)}
                      className={`cursor-pointer ${menu === 1 && 'font-semibold text-[#82b3ff]'}`}
                    >
                      Deskripsi
                    </button>
                    <button
                      onClick={() => setMenu(2)}
                      className={`cursor-pointer ${menu === 2 && 'font-semibold text-[#82b3ff]'}`}
                    >
                      Tiket
                    </button>
                    <button
                      onClick={() => setMenu(3)}
                      className={`cursor-pointer ${menu === 3 && 'font-semibold text-[#82b3ff]'}`}
                    >
                      Syarat & Ketentuan
                    </button>
                  </div>
      ...
      <AuthModal visible={authModalVisible} onClose={() => setAuthModalVisible(false)} />
                    ...
                    <button
                      className={`text-primary-base bg-white shadow-md rounded-full py-2 font-semibold w-full ${
                        menu === 2 ? 'opacity-0 cursor-default' : 'opacity-100'
                      } transition-opacity`}
                      onClick={() => {
                        setMenu(2);
                      }}
