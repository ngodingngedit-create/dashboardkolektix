      ...
      {data.length > 0 ? (
        <div className='border-2 border-primary-light-200 text-dark rounded-lg'>
          {data.map((item: BankProps) => (
            <div
              className='flex justify-between items-center px-5 py-4 border-b-2 border-b-primary-light-200'
              key={item.id}
            >
          ...
          <div className='flex items-center gap-4 p-5'>
            <button
              className='w-10 h-10 bg-primary-dark text-white rounded-lg hover:text-primary-dark hover:bg-primary-light-200 transition-colors'
