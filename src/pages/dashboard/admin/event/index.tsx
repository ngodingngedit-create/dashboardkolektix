            ...
            <Stack className={`p-[20px] md:p-[30px]`} gap={30}>
                ...
                <TableData
                    ...
                    mapData={(e: any) => ({
                        ...
                        image: (
                            <Image src={e.image_url} w={50} />
                        ),
                        name: e.name,
                        creator: <Group align="center">
                            <Avatar src={e?.has_creator?.image_url} />
                            <Text>{e?.has_creator?.name}</Text>
                        </Group>,
                        status: <Badge color={Boolean(e?.main_status) ? 'green' : 'gray'} variant="light" className={`[&_*]:text-[12px]`}>
                    ...
                    actionIcon={[
                        { icon: 'uiw:right', text: 'Lihat Detail' }
                    ]}
                />
            </Stack>
        </>
